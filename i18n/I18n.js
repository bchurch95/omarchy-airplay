...
var messages = {
  en: {
    airplayMirror: "Universal Cast",
    mirroringTo: "Mirroring to {name}",
    readyFor: "Ready for {name}",
    chooseReceiver: "Choose a display or TV",
    discoverReceivers: "Discover displays",
    receivers: "SCREENS & DISPLAYS",
    mirror: "Cast",
    stop: "Stop",
    forget: "Forget",
    mirrorTooltip: "Start casting to this display",
    stopTooltip: "Stop casting",
    ...
    openReceiverList: "Click the Cast icon in the bar to open display and speaker list.",
    noReceivers: "No displays or TVs found",
    discoveryFailed: "Display discovery failed",
